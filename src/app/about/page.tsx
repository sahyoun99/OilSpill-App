...
const researchers = [
  ...
  { 
    ...
    specialization: 'Professor of Computer Science and Engineering',
    bio: 'Faculty mentor guiding the team in applying deep learning and computer vision techniques for oil spill detection and segmentation.',
    achievements: ['20+ Publications', 'Academic Mentorship', 'Industry Collaborations']
  },
  { 
    ...
    affiliation: 'American University of Sharjah',
    specialization: 'Professor of Mechanical Engineering',
    bio: 'Co-supervised the project with expertise in SAR imagery and its environmental applications, particularly in marine pollution monitoring.',
    achievements: ['20+ Publications', 'Academic Mentorship', 'Industry Collaborations']
  },
  ...
  { 
    ...
    affiliation: 'American University of Sharjah',
    specialization: 'Computer Vision & Deep Learning for Oil Spill Detection',
    bio: 'Part of a student research team that developed a computer vision model for oil spill detection and segmentation using deep learning techniques.',
    achievements: ['Developed Oil Spill Segmentation Model', 'Computer Vision Research Project', 'Collaborative AI Development']
  },
  { 
    name: 'Aljawharah Alanazi', 
    role: 'AI Researcher', 
    img: 'https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/default-profile-picture-female-icon.png', 
    contact: 'g00091308@aus.edu',
    affiliation: 'American University of Sharjah',
    specialization: 'Computer Vision & Deep Learning for Oil Spill Detection',
    bio: 'Part of a student research team that developed a computer vision model for oil spill detection and segmentation using deep learning techniques.',
    achievements: ['Developed Oil Spill Segmentation Model', 'Computer Vision Research Project', 'Collaborative AI Development']
